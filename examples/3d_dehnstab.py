...
my_mechanical_system.load_mesh_from_gmsh('../meshes/test_meshes/bar_Tet4_fine.msh', phys_group=29)
...
top = my_mechanical_system.mesh_class.boundary_dict[31]
bottom = my_mechanical_system.mesh_class.boundary_dict[30]
...
my_neumann_boundary_list = [[[amfe.node2total(top[0], 0, 3),], 'static', (1E11, ), None]]
